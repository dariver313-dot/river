...
- Information architecture: explain public visibility inline when it is selected or confirmed; do not use a catch-all public-permissions dialog. Put account security actions in Personal Info → Data & Security, and put administrator-only public/system audit events in a User Management tab.
